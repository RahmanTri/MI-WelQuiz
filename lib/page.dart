...
class _QuizPageState extends State<QuizPage> {
  ...
  void checkAnswer(bool userPickedAnswer) { // mengambil data jawaban user  
    bool correctAnswer = quizBrain.getQuestionAnswer(); // mengambil jawaban dari quizBrain dan measukkan ke dalam variabel correctAnswer
    int currentIndex = quizBrain.getQuestionNumber(); // mengambil nomor soal dari quizBrain dan memasukkan ke dalam variabel currentIndex
